...
#ifndef SHARE_RISCV64_VM_BARRIERSETCONFIG_RISCV64_HPP
#define SHARE_RISCV64_VM_BARRIERSETCONFIG_RISCV64_HPP

#include "utilities/macros.hpp"

// Do something for each concrete barrier set part of the build.
#define FOR_EACH_CONCRETE_BARRIER_SET_DO(f)          \
  f(CardTableBarrierSetRv)
...
#endif // SHARE_RISCV64_VM_BARRIERSETCONFIG_RISCV64_HPP
