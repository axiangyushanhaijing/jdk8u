...
class ModRefBarrierSetRv: public BarrierSetRv {
protected:
  ModRefBarrierSetRv(BarrierSetAssembler* barrier_set_assembler)
    : BarrierSetRv(barrier_set_assembler) { }
  ~ModRefBarrierSetRv() { }
...
public:
 ...
 /*public:
  ...
  class AccessBarrier: public BarrierSetRv::AccessBarrier<decorators, BarrierSetT> {
    typedef BarrierSetRv::AccessBarrier<decorators, BarrierSetT> Raw;
...
/*template<>
struct BarrierSetRv::GetName<ModRefBarrierSetRv> {
  static const BarrierSetRv::Name value = BarrierSetRv::ModRef;
};*/
