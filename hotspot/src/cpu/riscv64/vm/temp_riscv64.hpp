...
/*void BarrierSetAssembler::load_at(MacroAssembler* masm, DecoratorSet decorators, BasicType type,
  ...
  case T_LONG:    __ fld(f0, src);
                  __ addi(esp, esp, -2 * wordSize);
                  __ fsd(f0, Address(esp));
                  __ lw(dst, Address(esp));
                  __ lw(dst + 1, Address(esp, wordSize));
                  __ addi(esp, esp, 2 * wordSize);  break;
...
void BarrierSetAssembler::store_at(MacroAssembler* masm, DecoratorSet decorators, BasicType type,
  ...
  case T_LONG:    __ addi(esp, esp, -2 * wordSize);
                  __ sw(val + 1, Address(esp, wordSize));
                  __ sw(val, Address(esp));
                  __ fld(f0, Address(esp));
                  __ fsd(f0,  dst);
                  __ addi(esp, esp, 2 * wordSize); break;
